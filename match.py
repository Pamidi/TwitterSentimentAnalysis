...
class Match:
    ...
    def get_event_hierarchy_tree(self):
        ...
        l1_n2 = Event('WICKET', keywords=['wicket','out','lbw','leg before wicket','caught','bowled', 'run out', 'runout'], is_dynamic = True)
        ...
        l1_n7 = Event('CENTURY',keywords=['century','hundred'], is_dynamic  = True)
        l1_n8 = Event('HALF_CENTURY',keywords=['fifty','half century'],is_dynamic=  True)
